...
| **Descripción** | En esta interfaz el administrador podrá crear, actualizar o borrar información de clientes, trabajadores, productos y servicios de eventos. Donde el administrador ingresa a la página de la microempresa por medio de una url después ingresa su usuario y contraseña ahí lo dirige al menú principal. Después le dará clic en el botón gestión de información, se desplegará un menú con varias opciones de información de productos, de clientes, trabajadores y servicios de eventos donde podrá modificar crear y actualizar todos estos datos.|
